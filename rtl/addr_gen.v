...
module addr_gen (
    ...
    output reg  [31:0] wl_base,      // this layer's weights base (bytes)
    output reg  [31:0] sl_base       // this layer's state base (bytes)
);
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            wl_base <= wl_base + {16'd0, l_stride};
            sl_base <= sl_base + {16'd0, st_stride};
        end
    end
endmodule
